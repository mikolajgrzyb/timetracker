...
ActiveRecord::Schema.define(version: 20141004134135) do
ActiveRecord::Schema.define(version: 20141005081723) do
  ...
  add_index "invitations", ["invitee_email"], name: "index_invitations_on_invitee_email", using: :btree
